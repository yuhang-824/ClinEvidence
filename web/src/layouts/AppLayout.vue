...
const fetchGithubStars = async () => {
  try {
    ...
    // 公共API，可以直接使用fetch
    const response = await fetch('https://api.github.com/repos/yuhang-824/ClinEvidence')
...
const organizationName = computed(() => {
  return infoStore.organization.name || infoStore.branding.name || 'ClinEvidence'
})
      ...
      <div class="foo">
        <div class="github nav-item" @click.stop>
          <a-tooltip placement="right" :open="sidebarCollapsed ? undefined : false">
            ...
            <a href="https://github.com/yuhang-824/ClinEvidence" target="_blank" class="github-link">
