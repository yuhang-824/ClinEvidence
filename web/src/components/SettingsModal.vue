    ...
    <div class="settings-container">
      ...
      <div class="settings-sider">
        ...
        <div v-if="showStarCard" class="settings-star-card">
          ...
          <p class="star-card-title">给 ClinEvidence 点个 Star</p>
          ...
          >
            <img
              ...
              src="https://img.shields.io/github/stars/yuhang-824/ClinEvidence?label=ClinEvidence&style=social"
              alt="GitHub stars for ClinEvidence"
            />
...
const projectRepoUrl = 'https://github.com/yuhang-824/ClinEvidence'
