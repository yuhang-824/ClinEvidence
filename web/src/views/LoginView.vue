  ...
  <div class="login-view" :class="{ 'has-alert': serverStatus === 'error' }">
    ...
    <footer class="page-footer">
      <div class="footer-links">
        <a href="https://github.com/yuhang-824/ClinEvidence/issues" target="_blank">联系我们</a>
        <span class="divider">|</span>
        <a href="https://github.com/yuhang-824/ClinEvidence" target="_blank">使用帮助</a>
      </div>
      <div class="copyright">
...
const brandName = computed(() => {
  ...
  const brandNameRaw = infoStore.branding?.name?.trim() || 'ClinEvidence'
