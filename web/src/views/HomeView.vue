    ...
    <template v-else>
      ...
      <header class="site-header">
        ...
        <div class="header-actions">
          <a
            class="github-link"
            href="https://github.com/yuhang-824/ClinEvidence"
            target="_blank"
      ...
      <main class="hero-section">
        ...
        <div class="hero-content">
          <p class="hero-eyebrow reveal-up">
            <span class="eyebrow-dot"></span>ClinEvidence · 医疗 Agent 开发演示
          </p>
...
const docsUrl = 'https://github.com/yuhang-824/ClinEvidence#readme'
